...
A biblioteca muda um pouco o funcionamento da linguagem, funções como console.log(), Date, entre outras funções não são usadas, e não funcionam corretament. Não sei exatamente qual versão do javascript o SkyX usa, mas com certeza não é ES6, nem o ES5. Do que eu pude ver me parece ser um versão não muito recente da linguagem. É como se fosse uma própria versão do javascript preparada pro SkyX.
